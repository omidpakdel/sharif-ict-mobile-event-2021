...
class EmployeesHomeView extends StatefulWidget {
  const EmployeesHomeView({Key? key}) : super(key: key);

  @override
  State<EmployeesHomeView> createState() => _EmployeesHomeViewState();
}

class _EmployeesHomeViewState extends State<EmployeesHomeView> {
            ...
            Padding(
              ...
              child: Container(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      Navigator.pushNamed(context, '/entries-report');
                    },
